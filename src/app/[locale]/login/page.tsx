...
export default async function LoginPage({params}: PageProps) {
  ...
  return (
    <section className="relative isolate min-h-[calc(100dvh-96px)] overflow-hidden bg-white">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1200px] min-h-[calc(100dvh-96px)]">
        <div dir="ltr" className="grid grid-cols-1 md:grid-cols-2 min-h-inherit">
          {/* Spacer column to balance the full-bleed panel */}
          <div className="hidden md:block md:col-start-1" />

        {/* Right: form card */}
        <div className="flex items-center justify-center px-6 py-10 md:py-12 md:col-start-2">
